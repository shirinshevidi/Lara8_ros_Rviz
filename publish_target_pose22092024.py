...
def holding(pose_element, element_name):
    ...
    if success : 
        ...
        if iteration > 0: 
            rospy.loginfo(f"the target was not reachable but Robot is ready to hold with {90 * iteration} degree rotation ")
        else:
            rospy.loginfo("Robot is ready to hold successfully.")
