...
def add_cube():
    ...
    scene.add_box("element1", cube_pose, size=(0.05, 0.03, 0.33))
    ...
    scene.add_box("element2", cube_pose, size=(0.05, 0.03, 0.33))
    ...
    scene.add_box("element3", cube_pose, size=(0.05, 0.020, 0.33))
